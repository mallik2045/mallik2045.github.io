...
<html lang="en">
    <head>
        ...
        <link rel = "icon" href =  "images/footprint.png" type = "images/footprint.png"> 
...
s1.async=true;
s1.src='https://embed.tawk.to/5f56f0ad4704467e89ecf256/default';
s1.charset='UTF-8';
...
<!--End of Tawk.to Script-->
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-6 d-flex align-items-center">
                        <p class="mb-0 phone pl-md-2">
                            <a href="#" class="mr-2"><span class="fa fa-phone mr-1"></span> +91 7032490016</a> 
                            <a href="#"><span class="fa fa-paper-plane mr-1"></span> nuthan@gmail.com</a>
                        </p>
                    </div>
                    <div class="col-md-6 d-flex justify-content-md-end">
                        <div class="social-media">
                            <p class="mb-0 d-flex">
                                <a href="https://www.facebook.com/nuthanreddyalchala" target="_blank" class="d-flex align-items-center justify-content-center"><span class="fa fa-facebook"><i class="sr-only">Facebook</i></span></a>
        ...
        <nav class="navbar navbar-expand-lg navbar-light ftco_navbar bg-light ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="index.php"><img src="images/footprint.png" style="vertical-align:middle;margin:0px 10px" class="rounded float-left" alt="" width="35" height="35" title="Aqua park">Aqua Park</a>
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="vet.html" class="nav-link">Pets</a></li>
        ...
        <div class="row mt-5">
            <div class="col-md-12 text-center">
                ...
                <p class="copyright"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made <i class="" aria-hidden="true"></i> by <a href="" target="_blank">RANGU MALLKARJUN</a>
